...
public class UsersRepositoryImpl implements UsersRepository {
    ...
    public Optional<User> findByUserName(String userName) {
        ...
        User user = null;
        try {
            user = template.queryForObject(sql, new UserRowMapper(), userName);
    ...
    public void saveMessage(String message) {
        template.update("insert into server.message (message, date_time) values (?, ?)", message, LocalDateTime.now());
    }
}
